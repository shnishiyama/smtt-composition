...
instance (Show syn1, Show inh1, Show syn2, Show inh2) => Show (ComposedSattSynAttr syn1 inh1 syn2 inh2) where
...
instance (Show syn1, Show inh1, Show syn2, Show inh2) => Show (ComposedSattInhAttr syn1 inh1 syn2 inh2) where
